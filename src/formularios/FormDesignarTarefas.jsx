...
export default function FormDesignarTarefas(props) {
  ...
  const [listadeVoluntariosSelecionados, setListadeVoluntariosSelecionados] =
    useState([]);
  ...
  return (
    <div>
      <Form
        ...
        validated={validado}
        className="Form_designar"
      >
        <Row className="alinhando_linhas_form_designar">
          <Col md={11}>
            <Tooltip
              title="Escolha uma atividade da lista de atividades disponíveis."
              placement="left"
        ...
        <Row
          ...
          className="alinhando_linhas_form_designar"
        >
          <Tooltip
            title="Informe a data para a designação da tarefa."
            placement="left"
            classes={{ tooltip: "custom-tooltip" }}
          >
          ...
          <Tooltip
            title="Informe a hora para a designação da tarefa."
            placement="left"
            classes={{ tooltip: "custom-tooltip" }}
          >
        ...
        <Row className="alinhando_linhas_form_designar">
          <Col md={11}>
            <Tooltip
              title="Selecione um voluntário da lista."
              placement="left"
              classes={{ tooltip: "custom-tooltip" }}
            >
              <div>
        ...
        <Row className="alinhando_linhas_form_designar">
          ...
          <Tooltip
            title="Clique para adicionar o voluntário selecionado à lista de tarefas."
            placement="left"
            classes={{ tooltip: "custom-tooltip" }}
          >
            <Form.Group as={Col} md="1" controlId="acrescentar">
              <Button
                ...
                onClick={() => {
                  ...
                  setListadeVoluntariosSelecionados([
                    ...listadeVoluntariosSelecionados,
                    vol1,
                  ]);
                }}
                style={{ marginTop: "30px" }}
        ...
        <Row>
          <TabelaDesignarVoluntarios
            ...
            setListaItens={setListadeVoluntariosSelecionados}
          ></TabelaDesignarVoluntarios>
        </Row>
        <Row className="alinhando_botao_designar">
          <Button type="submit" className="botao_designar">
            Gravar Tarefa
          </Button>
        </Row>
        <a
          href="/manuais/manual_designar_tarefas.pdf"
          download="manual_designar_tarefas.pdf"
        >
